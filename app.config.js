...
class AppConfig {
    ...
    get VTS_MIDI_VERSION() { return process.env.vts_midi_version ?? "1.0.0" }
    ...
    get MINT_DESKTOP_VERSION() { return process.env.mint_desktop_version ?? "1.0.0" }
    get MINT_DESKTOP_DATE() { return process.env.mint_desktop_date ?? "10/01/2024" }
    get MINT_DESKTOP_URL() { return process.env.mint_desktop_url ?? "https://www.skeletom.net" }

    get KK_DESKTOP_VERSION() { return process.env.kk_desktop_version ?? "1.0.0" }
    get KK_DESKTOP_DATE() { return process.env.kk_desktop_date ?? "04/04/2025" }
    get KK_DESKTOP_URL() { return process.env.kk_desktop_url ?? "https://www.skeletom.net" }

    get WORD_SALAD_VERSION() { return process.env.word_salad_version ?? "1.0.0" }
    get WORD_SALAD_DATE() { return process.env.word_salad_date ?? "01/30/2025" }
    get WORD_SALAD_URL() { return process.env.word_salad_url ?? "https://www.skeletom.net" }

    get VTS_COUNTER_VERSION() { return process.env.vts_counter_version ?? "1.0.0" }
